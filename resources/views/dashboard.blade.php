...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .service-img-wrap { border-radius: 12px; overflow: hidden; height: 220px; margin-bottom: 1rem; }
        .service-img {
        ...
        /* hover zoom triggered by anchor, not col */
        ...
        /* ── WHY CHOOSE US ── */
        .why-choose-section { background-color: var(--custom-beige); padding: 55px 0; }
        .number {
        ...
        .typing-cursor {
            ...
            background: #555; margin-left: 1px;
        ...
        /* ── FEEDBACK ── */
        .feedback-section { padding: 44px 0; }
        .testimonial-card {
            background-color: #fcfcfc; border: 1.1px solid #ddd; border-radius: 14px;
        ...
        .testimonial-service { font-size: 0.78rem; color: #666; margin-bottom: 8px; }
        .stars { color: var(--star-gold); font-size: 1.1rem; margin-top: 10px; display: flex; align-items: center; gap: 4px; }
        .stars .date { font-size: 0.76rem; color: #888; margin-left: 10px; font-family: 'Poppins', sans-serif; font-weight: 400; }
...
<body>
    ...
    <section id="services" class="container section-py text-center">
        ...
        <h2 class="section-heading fw-bold mb-2">Three Experiences, One Destination</h2>
        <p class="text-muted mx-auto mb-4" style="max-width: 600px; font-size: 0.83rem;">
            Discover everything TN has to offer, from culinary delights to peaceful retreats.
        </p>
        <div class="row g-4">
            <div class="col-md-4 col-12">
                <a href="{{ route('restaurant') }}" class="service-card-link">
                    ...
                    <h3 class="h5 fw-bold mb-1">Fine Dining</h3>
                    <p class="text-muted px-2 mb-2" style="font-size: 0.82rem;">Savor exquisite cuisines crafted by our experienced chefs using the freshest local ingredients.</p>
            ...
            <div class="col-md-4 col-12">
                <a href="{{ route('lodging') }}" class="service-card-link">
                    ...
                    <h3 class="h5 fw-bold mb-1">Lodging</h3>
                    <p class="text-muted px-2 mb-2" style="font-size: 0.82rem;">Rest in beautifully appointed rooms with premium amenities. Choose from standard rooms to suites.</p>
            ...
            <div class="col-md-4 col-12">
                <a href="{{ route('spa') }}" class="service-card-link">
                    ...
                    <h3 class="h5 fw-bold mb-1">Spa & Wellness</h3>
                    <p class="text-muted px-2 mb-2" style="font-size: 0.82rem;">Indulge in a curated selection of spa treatments designed to relax, restore, and rejuvenate.</p>
    ...
    <section class="why-choose-section">
        <div class="container text-center">
            ...
            <h2 class="section-heading fw-bold mb-4">A Legacy Of Excellence</h2>
            <div class="row g-4">
    ...
    <section class="container feedback-section">
        ...
        <h2 class="text-center section-heading fw-bold mb-4">What Our Guests Say</h2>
